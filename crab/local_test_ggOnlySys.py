...
from PhysicsTools.NanoAODTools.postprocessing.modules.common.gammaSFProducer_onlyLookUpTable import *
...
files=["/home/users/legianni/test_nanoaod.root"]
...
p=PostProcessor(".",files,       
                  ...
                  modules=[puAutoWeight_2018(),jetmetUncertainties2018(), muonScaleRes2018(),  gammaSFL()],
                  provenance=True)
